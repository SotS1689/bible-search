...
(function (global) {
  ...
  // ---------- Hebrew <-> Greek, Proverbs. The corpus DB's own Greek chapter
  // numbers for Proverbs now match Hebrew throughout (Heb/Grk 25-29, "these
  // also are proverbs of Solomon, which the men of Hezekiah... copied
  // out," was originally imported under CATSS's native Grk 32-36 -- see
  // src/renumber_prov_grk.py -- and has been renumbered in the DB itself
  // to 25-29 so no runtime remapping is needed for it). The one remaining
  // difference is a confirmed verse swap at 31:25/26. A few other spots
  // BibleWorks 10's bgt.vmf versification map flags (Prov 1:10-11, 3:3-4,
  // 11:10-11, 16:6-9, 22:8-9, 31:27-28) turned out on inspection to
  // either match the Hebrew numbering exactly already or involve a
  // genuine LXX doublet/plus-verse with no single clean Hebrew
  // counterpart -- left unmapped like Jeremiah's own single-verse gaps,
  // see file header.
